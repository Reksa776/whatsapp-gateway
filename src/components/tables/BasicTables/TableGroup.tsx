...
export default function TableGroup({ data = [], onDelete, onEdit }) {
  const { isOpen, openModal, closeModal } = useModal();
  const [groupEdit, setGroupEdit] = useState({ id: 0, namaKategori: "", namaGroup: "" });
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]">
      ...
      ><FormEdit title="Edit Data" data={groupEdit} onSuccess={() => {
        onEdit();
        closeModal();
      }}/></Modal>
